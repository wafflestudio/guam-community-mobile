...
class InterestsEditTextField extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => InterestsEditTextFieldState();
}

class InterestsEditTextFieldState extends State<InterestsEditTextField> {
  bool sending = false;
